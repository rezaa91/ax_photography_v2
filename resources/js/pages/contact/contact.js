                ...
                <div className="contact-section">
                            ...
                            <form onSubmit={this.submitForm}>
                                ...
                                {formSubmitted && (
                                    <span className="form-submitted">
                                        Thank you for your email, I will aim to
                    ...
                    <div className="contact-footer">
                        <div className="social-media-wrapper">
                            <span className="icon">
                                <a
                                    href="https://www.flickr.com/photos/68234194@N05/"
                                    target="_blank"
                                >
                                    <span className="fab fa-flickr" />
                                </a>
                            </span>
                            <span className="icon inactive">
                                <a title="unavailable" target="_blank">
