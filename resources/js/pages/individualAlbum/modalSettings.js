...
function getModalHeightProperties() {
    const {modal, modalHeader, modalImageWrapper, modalFooter, modalImage} = getDOMElements();
...
function setImageWrapperHeight() {
    ...
    const {modalHeight, modalHeaderHeight, modalFooterHeight} = getModalHeightProperties();
